...
export default function Hero () {
    return (
        <section className='sm:flex justify-between py-10 sm:px-16 px-10'>
            <div className='bg-[#54A6FF] h-[232px] sm:w-[630px] sm:h-[360px] my-1 rounded-[10px] relative'>
                ...
                height={360}
                alt='' 
                className='w-80 h-60 sm:w-[640px] sm:h-[360px] absolute  sm:relative top-8 sm:top-0 right-4 sm:right-0'/>
            </div>
