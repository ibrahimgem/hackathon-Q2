    ...
    return (
        <section className='mx-16 flex justify-between py-10'>
            <div className='bg-[#54A6FF] w-[640px] h-[360px] rounded-[10px] relative'>
                <div className='absolute p-6 text-[32px] text-white w-[350px]'>The Best Platform for Car Rental</div>
            ...
            <div className='bg-[#3563E9] w-[640px] h-[360px] rounded-[10px] relative'>
                <div className='absolute p-6 text-[32px] text-white w-[350px]'>Easy way to rent a car at a low price</div>
