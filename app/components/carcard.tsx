...
const CarCard: React.FC<CarProps> = ({ name, image: Image, price, fuelTank, transmission, capacity }) => {
    return (
        <div className="border rounded-lg shadow-md p-4 max-w-sm">
            ...
            <div className="flex flex-col">
                <div className="mt-2 flex justify-between items-center">
                    ...
                    <span className="text-gray-600 font-bold">{fuelTank}</span>
                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <span className="text-gray-600 font-bold">{transmission}</span>
                    ...
                    <span className="text-gray-600 font-bold">{capacity}</span>
                    <div />
                    <div className="mt-2 flex justify-between items-center">
                        <div className="mt-2 flex justify-between items-center">
                            <span className="text-blue-600 font-bold">${price}/day</span>
                            <button className="bg-blue-600 text-white py-1 px-4 rounded-lg hover:bg-blue-700">
                                Rent Now
                            </button>
                        </div>
                    </div>
